...
```
earthquake-pipeline/│── notebooks/│   ├── Bronze-Layer-Processing.ipynb   # Fetch raw API data│   ├── Dilver-Layer-Processing.ipynb   # Transform JSON → structured tables│   ├── Gold-Layer-Processing.ipynb    # Add country codes & classifications│── images/│   ├── architecture.png│   ├── orchestration.json│── README.md
```
